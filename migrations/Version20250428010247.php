 ...
 */
final class Version20250428010247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_mecanicien CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_remorquage CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_mecanicien CHANGE status status VARCHAR(255) DEFAULT 'en_cours_de_traitement' NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_remorquage CHANGE status status VARCHAR(255) DEFAULT 'en_cours_de_traitement' NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
