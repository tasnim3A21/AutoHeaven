 ...
 */
final class Version20250331074552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE avis CHANGE id_a id_a INT NOT NULL, CHANGE commentaire commentaire LONGTEXT NOT NULL, CHANGE id id INT DEFAULT NULL, CHANGE id_v id_v INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_avis ON avis
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_8F91ABF0BF396750 ON avis (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_av ON avis
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_8F91ABF0ACF191FB ON avis (id_v)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE camion_remorquage CHANGE id_cr id_cr INT NOT NULL, CHANGE statut statut VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie CHANGE id_c id_c INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE commande CHANGE id_com id_com INT NOT NULL, CHANGE id id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE equipement CHANGE id id INT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE image image LONGTEXT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE lignecommande CHANGE id_l id_l INT NOT NULL, CHANGE id_e id_e INT DEFAULT NULL, CHANGE idc idc INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie MODIFY id_m INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX `primary` ON messagerie
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie DROP FOREIGN KEY fk_reclamation_id
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie DROP id_user, DROP sender, DROP receiver, CHANGE id_rec id_rec INT DEFAULT NULL, CHANGE message message LONGTEXT NOT NULL, CHANGE id_m id INT AUTO_INCREMENT NOT NULL, CHANGE datemessage date_envoi DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD CONSTRAINT FK_14E8F60CFAA12276 FOREIGN KEY (id_rec) REFERENCES reclamation (id_rec)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD PRIMARY KEY (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offre CHANGE id_offre id_offre INT NOT NULL, CHANGE type_offre type_offre VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE panier CHANGE id_p id_p INT NOT NULL, CHANGE id id INT DEFAULT NULL, CHANGE id_e id_e INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE contenu contenu LONGTEXT NOT NULL, CHANGE status status VARCHAR(255) DEFAULT 'en_attente' NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_mecanicien CHANGE id_u id_u INT NOT NULL, CHANGE id_mec id_mec INT NOT NULL, CHANGE adresse adresse VARCHAR(25) NOT NULL, CHANGE note note VARCHAR(100) NOT NULL, CHANGE date date DATE NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_remorquage CHANGE id_cr id_cr INT NOT NULL, CHANGE id_u id_u INT NOT NULL, CHANGE point_ramassage point_ramassage VARCHAR(25) NOT NULL, CHANGE point_depot point_depot VARCHAR(25) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_testdrive CHANGE id_u id_u INT NOT NULL, CHANGE id_v id_v INT NOT NULL, CHANGE date date DATE NOT NULL, CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE stock CHANGE id_s id_s INT NOT NULL, CHANGE id id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_4B365660BF396750 ON stock (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE id id INT NOT NULL, CHANGE photo_profile photo_profile VARCHAR(255) NOT NULL, CHANGE ban ban VARCHAR(10) NOT NULL, CHANGE question question VARCHAR(255) NOT NULL, CHANGE reponse reponse VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE voiture CHANGE id_v id_v INT NOT NULL, CHANGE id_c id_c INT DEFAULT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE image image LONGTEXT NOT NULL, CHANGE disponibilite disponibilite VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie MODIFY id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD id_user INT DEFAULT NULL, ADD sender VARCHAR(255) NOT NULL, ADD receiver VARCHAR(255) NOT NULL, CHANGE id_rec id_rec INT NOT NULL, CHANGE message message TEXT NOT NULL, CHANGE id id_m INT AUTO_INCREMENT NOT NULL, CHANGE date_envoi datemessage DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD CONSTRAINT fk_reclamation_id FOREIGN KEY (id_rec) REFERENCES reclamation (id_rec) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD PRIMARY KEY (id_m)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE contenu contenu TEXT NOT NULL, CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
