 ...
 */
final class Version20250331004729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE avis CHANGE id_a id_a INT NOT NULL, CHANGE id id INT DEFAULT NULL, CHANGE id_v id_v INT DEFAULT NULL, CHANGE commentaire commentaire LONGTEXT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie DROP id_user, DROP sender, DROP message, DROP datemessage, DROP receiver, CHANGE id_rec id_rec INT DEFAULT NULL, CHANGE id_m id INT AUTO_INCREMENT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE contenu contenu LONGTEXT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD id_user INT DEFAULT NULL, ADD sender VARCHAR(255) NOT NULL, ADD message TEXT NOT NULL, ADD datemessage DATETIME NOT NULL, ADD receiver VARCHAR(255) NOT NULL, CHANGE id_rec id_rec INT NOT NULL, CHANGE id id_m INT AUTO_INCREMENT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie ADD CONSTRAINT fk_reclamation FOREIGN KEY (id_rec) REFERENCES reclamation (id_rec) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE contenu contenu TEXT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
