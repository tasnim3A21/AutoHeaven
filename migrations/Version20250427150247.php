 ...
 */
final class Version20250427150247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, message VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_read TINYINT(1) NOT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE avis MODIFY id_a INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messagerie CHANGE message message LONGTEXT NOT NULL, CHANGE id_rec id_rec INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE res_testdrive CHANGE id_td id_td INT AUTO_INCREMENT NOT NULL, CHANGE id_u id_u INT NOT NULL, CHANGE id_v id_v INT NOT NULL, CHANGE date date DATE NOT NULL, CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE photo_profile photo_profile VARCHAR(255) NOT NULL, CHANGE ban ban VARCHAR(10) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE voiture CHANGE description description LONGTEXT NOT NULL, CHANGE image image LONGTEXT NOT NULL, CHANGE id_c id_c INT DEFAULT NULL, CHANGE disponibilite disponibilite VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE role role VARCHAR(255) NOT NULL, CHANGE photo_profile photo_profile VARCHAR(255) DEFAULT NULL, CHANGE ban ban VARCHAR(255) DEFAULT 'non'
        SQL);
        $this->addSql(<<<'SQL'
